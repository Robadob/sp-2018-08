...
###
csvDefault = loadCSV('[2D] Default, Avg Model.csv');
csvStrips = loadCSV('[2D] Strips, Avg Model.csv');
...
### Export/Show Plot
###
plt.savefig('[2D] Avg 1.0.eps')
plt.savefig('[2D] Avg 1.0.pdf')
plt.savefig('[2D] Avg 1.0.png')
plt.close();
#plt.show();
