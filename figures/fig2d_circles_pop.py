...
###
csvDefault = loadCSV('[2D] Default, Circles Model, Scaling Pop.csv');
csvStrips = loadCSV('[2D] Strips, Circles Model, Scaling Pop.csv');
...
### Export/Show Plot
###
plt.savefig('[2D] Circles Pop.eps')
plt.savefig('[2D] Circles Pop.pdf')
plt.savefig('[2D] Circles Pop.png')
plt.close();
#plt.show();
